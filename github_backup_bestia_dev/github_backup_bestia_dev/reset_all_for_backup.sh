# /d/box_original_1/BestiaDev/github_backup_bestia_dev/github_backup_bestia_dev/reset_all_for_backup.sh

cur_dir="/d/box_original_1/BestiaDev/github_backup_bestia_dev/github_backup_bestia_dev"
