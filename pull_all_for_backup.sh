# /d/Dropbox/BestiaDev/github_backup/pull_all_for_backup.sh

cur_dir="/d/Dropbox/BestiaDev/github_backup"
...
printf "\033[0;33m    Num of super-folders: 4 \033[0m\n"
printf " \n"
...
for folder in $(ls -d $cur_dir/.[!.]*/ $cur_dir/*/ 2> /dev/null) ; do
    cd $folder
    printf "\n"
    printf "\033[0;33m  $COUNTER. superfolder \033[0m\n"
    pwd
    COUNTER=$((COUNTER+1))  
