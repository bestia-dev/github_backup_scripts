# /d/Dropbox/BestiaDev/github_backup/github_backup_active/github_backup_bestia_dev/pull_all_for_backup.sh

cur_dir="/d/Dropbox/BestiaDev/github_backup/github_backup_active/github_backup_bestia_dev"
