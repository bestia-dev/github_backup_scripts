# /d/box_original_1/BestiaDev/github_backup_bestia_dev/github_backup_active/github_backup_bestia_dev/push_all_for_backup.sh

cur_dir="/d/box_original_1/BestiaDev/github_backup_bestia_dev/github_backup_active/github_backup_bestia_dev"
...
cd $cur_dir/
printf "\033[0;33m    Num of repositories should be: 51 \033[0m\n"
printf " \n"
