# /d/Dropbox/BestiaDev/github_backup/github_backup_active/github_backup_CRUSTDE_ContainerizedRustDevEnv/pull_all_for_backup.sh

cur_dir="/d/Dropbox/BestiaDev/github_backup/github_backup_active/github_backup_CRUSTDE_ContainerizedRustDevEnv"
