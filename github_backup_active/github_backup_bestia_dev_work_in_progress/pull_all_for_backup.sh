# BestiaDev/github_backup_bestia_dev/github_backup_active/github_backup_bestia_dev_work_in_progress/pull_all_for_backup.sh
...
printf "\033[0;33m    Num of repositories should be: 20 \033[0m\n"
printf " \n"